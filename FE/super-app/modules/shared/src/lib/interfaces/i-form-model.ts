...
import { Func, ObjectType } from '../classes/model/common';
import { Filter, FilterOperator } from '../classes/model/crud';
import { DataType } from '../enum/form';
...
export interface IFormField {
    ...
    label?: string;
    /** Tooltip hiển thị cho field */
    fullLabel?: string;
    /** Kiểu dữ liệu của fiel    /** Giá trị của field */
    value?: any;
    ...
    headerClass?: string;
    bodyClass?: string;
    separator: string; // Trong trường hợp field là reference
    pipe?: PipeTransform;
    pipeParams?: any[];
    asyncPipe: boolean;
    //#endregion
...
export interface IParentField {
    field: string;
    valueField: string;
    funcGetValueField?: (obj: ObjectType) => any;
}

export interface IDataSource extends IFormField {
...
export interface IDropdown extends IDataSource {
...
// Interface cho Radio
export interface IRadio extends IDataSource {
